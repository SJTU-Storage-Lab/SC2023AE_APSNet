...
from model_source.PNet_2gru import GRU, PSiameseNetwork, DatasetUtil, ContrastiveLoss
...
#     np.save('./loss/loss_pnet_m1_m2_0_final.npy',Loss_list)
    torch.save(model, '../trained_model/' + dit_str[data_type] + '/' + str(n_days_lookahead) + '_days_lookahead/pnet_2gru.pkl')
