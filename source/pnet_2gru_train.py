...
from utils.PNet_2gru import GRU, PSiameseNetwork, DatasetUtil, ContrastiveLoss
...
#     np.save('./loss/loss_pnet_m1_m2_0_final.npy',Loss_list)
    torch.save(model, '../trained_model/' + model_folder_name_dict[model_type] + '/' + str(n_days_lookahead) + '_days_lookahead/pnet_2gru.pkl')
