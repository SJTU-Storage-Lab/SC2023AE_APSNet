...
torch.save(model.state_dict(), '../trained_model/' + model_folder_name_dict[model_type] + '/' + str(n_days_lookahead) + '_days_lookahead/nn_online.pth')
torch.save(optimizer.state_dict(), '../trained_model/' + model_folder_name_dict[model_type] + '/' + str(n_days_lookahead) + '_days_lookahead/nn_optimizer_online.pth')
...
for epoch in range(num_epochs):
    ...
    for i, (X, y) in enumerate(train_loader):
        ...
        optimizer.load_state_dict(torch.load('../trained_model/' + model_folder_name_dict[model_type] + '/' + str(n_days_lookahead) + '_days_lookahead/nn_optimizer_online.pth'))
